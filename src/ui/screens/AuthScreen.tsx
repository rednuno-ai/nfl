    ...
    <div className="auth-page">
      ...
      <footer className="auth-footer" aria-label="Account help and legal information">
        ...
        <div className="auth-legal-panels">
          <details id="privacy"><summary>Privacy</summary><p>Active playtime is measured while a career is visible and recently used. Account totals are visible only to the site owner and removed when the account is deleted. No input contents are stored. Do Not Track and Global Privacy Control disable this measurement.</p><p>{usesRemoteAuth() ? publicCopy.storage.server : publicCopy.storage.local}</p><p>Registration diagnostics count page openings, form steps and broad error categories. Only daily totals are stored for 60 days, without usernames, passwords, IP addresses or device identifiers. Do Not Track and Global Privacy Control are respected. Openings are not unique visitors.</p></details>
