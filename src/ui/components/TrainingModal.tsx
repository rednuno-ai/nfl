  ...
  return (
    <div className="modal-backdrop">
      <div className="modal" role="dialog" aria-modal="true">
        ...
        <div className="modal-body">Pick a focus. This affects which attributes develop and your morale this week — Active Recovery trades slower growth for a mental reset.</div>
